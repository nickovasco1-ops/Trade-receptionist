...
export const PLANS: PlanConfig[] = [
  {
    ...
    features: ['AI call answering 24/7', 'Diary integration (Google Calendar)', 'Call transcripts & summaries', 'SMS alerts to your mobile'],
  ...
  },
  {
    ...
    features: ['Everything in Starter', 'Priority call routing', 'Custom greetings', 'Higher call volume'],
    stripeUrl: urls.pro,
    popular:   true,
  },
  {
